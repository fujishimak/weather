...
<!-- 	<p>Click the button to get your coordinates.</p>
	...
	<div id="temp"  class="row">
		<div id="left-col" class="col-md-6 text-right">
			<div id="t-reading"></div>
			<div id="t-toggle"><input id="checkUnit" type="checkbox" checked data-toggle="toggle" data-on="Farenheit" data-off="Celsius" data-onstyle="primary" data-offstyle="success"/></div>
		</div>
<!-- 	</div>
